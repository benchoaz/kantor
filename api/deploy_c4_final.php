...
echo "\n[PHASE 1] Checking Camat App...\n";
if (is_dir($camatDir)) {
    echo "✅ Camat App directory found.\n";
} else {
    echo "⚠️ Camat App directory missing (Overlay might have failed).\n";
}

// === PHASE 2: SURATQU GOVERNANCE UPDATE ===
echo "\n[PHASE 2] Checking SuratQu...\n";
if (is_dir($suratquDir)) {
    echo "✅ SuratQu directory found.\n";
} else {
    echo "⚠️ SuratQu directory missing.\n";
}
